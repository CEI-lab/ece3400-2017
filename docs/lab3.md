...
Both subteams will need one FPGA and one Arduino. Both teams should download the template [here](https://github.com/rohern/ece3400/blob/master/lab3/Lab3_template.zip) and modify the top-level module DE0_NANO.v.
