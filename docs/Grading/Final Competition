# ECE 3400, Fall 2017 - Final Competition Rubric
...
At the end of each round, a score will be given to your team with a maximum of 20 points based on your robot and base station’s performance during that round. The following grading scheme is applied at every round for every robot that is competing.
...
* If you do not correctly distinguish between unexplored and unexplorable (any kind of confusion) space, 3 points will be deducted from your score.

* If a treasure is not displayed/identified, or is displayed incorrectly (wrong location), that’s a 2-point penalty.

* If a treasure is not identified correctly (according to frequency), that’s a 2-point penalty.
...
* If the video base station does not display the "done" signal correctly, that’s a 1-point deduction.
