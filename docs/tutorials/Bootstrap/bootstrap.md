...
<img src="modifying-portfolio.png" width="720" height="450" />
...
<img src="modifying-portfolio-cols.png" width="720" height="450" />
...
<img src="lab-modal.png" width="720" height="450" />
...
<img src="lab-image.png" width="720" height="450" />
...
### Overview
This should be enough to get you started with using Bootstrap. There are a lot of things I didn't mention here that was covered by the tutorial. The Bootstrap documentation is also very helpful to learn more about Bootstrap (if you are following the youtube tutorial I linked above, make sure to select version 3.x on the Bootstrap website; the video covers that particular version but version 4 has since been released). Overall, you really don't need to know all the ins and outs of html and Bootstrap. Like I said above, trial and error is the fastest way of going about learning how the html code works. Good luck and feel free to ask me any questions about all of this if anything was unclear! 