# Eagle Tutorial
## Uses for Eagle
Eagle is a software program used for making electrical schematics and designing PCBs. Even in you don't intend to make a PCB, Eagle is still a useful tool for digitally laying out electical schematics. Eagle primarily uses two file types, .sch for schmatics and .brd files for PCB designs.
